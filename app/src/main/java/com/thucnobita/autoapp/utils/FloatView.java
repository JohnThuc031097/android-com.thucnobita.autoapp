...
public class FloatView extends FrameLayout {
    ...
    public FloatView(Context context, int idLayoutView) {
        super(context);
        this.context = context;

        windowManager = (WindowManager) getContext().getSystemService(Context.WINDOW_SERVICE);
        inflater = LayoutInflater.from(getContext()).inflate(idLayoutView, null);;
        ImageView imageView = new ImageView(this.context);
        imageView.setImageResource(R.drawable.bg_floating_view);
        addView(imageView);
    }
