package com.thucnobita.api.instagram.actions.upload;

import java.util.Arrays;
import java.util.concurrent.CompletableFuture;
import com.thucnobita.api.instagram.IGClient;
import com.thucnobita.api.instagram.models.media.UploadParameters;
import com.thucnobita.api.instagram.requests.upload.MediaUploadFinishRequest;
import com.thucnobita.api.instagram.requests.upload.RuploadPhotoRequest;
import com.thucnobita.api.instagram.requests.upload.RuploadSegmentVideoGetRequest;
import com.thucnobita.api.instagram.requests.upload.RuploadSegmentVideoPhaseRequest;
import com.thucnobita.api.instagram.requests.upload.RuploadSegmentVideoPhaseRequest.Phase;
import com.thucnobita.api.instagram.requests.upload.RuploadVideoRequest;
import com.thucnobita.api.instagram.responses.IGResponse;
import com.thucnobita.api.instagram.responses.media.RuploadPhotoResponse;
                ...
                .thenCompose(startResponse -> {
                    ...
                    do {
                        ...
                        uploadResponse = uploadResponse
                                ...
                                .thenCompose(res -> {
                                    Log.i("{} Uploading segment ({}/{})", upload_id, segment + 1,
                                            segments.length);
                                    ...
                                    return new RuploadSegmentVideoPhaseRequest(Phase.TRANSFER,
                                            ...
                                            String.valueOf(totalLengthBytes), segments[segment])
                                                    .execute(client)
                                                    .whenComplete((transRes, tr) -> Log.i(
